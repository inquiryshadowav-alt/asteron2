        ...
        {screen === "howto" && (
          <div className="stack">
            ...
            <ul className="muted list">
              ...
              <li>Coal ore is in stone on the surface and in caves. Craft torches from coal + a stick and place them on the ground or on blocks to light the night and the caves</li>
